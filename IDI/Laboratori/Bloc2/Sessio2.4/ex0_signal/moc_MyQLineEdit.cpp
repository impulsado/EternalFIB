...
QT_MOC_LITERAL(1, 12, 14), // "sendReturnText"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 4), // "text"
QT_MOC_LITERAL(4, 33, 17) // "SelfCaptureReturn"

    },
    "MyQLineEdit\0sendReturnText\0\0text\0"
    "SelfCaptureReturn"
};
...
void MyQLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendReturnText((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->SelfCaptureReturn(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyQLineEdit::sendReturnText)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyQLineEdit::sendReturnText(const QString & _t1)
{
