...
public:
  ...
  class iterator {
       ...
       el resultat és el p.i. */
    {
      ...
      if (isEntagled and itEn!=nullptr) {
        itEn->isEntagled = false;
        if (itEn->pitem != &(itEn->plist->itemsup)) (*itEn)++;
        itEn->isEntagled = true;
      }
      return *this;
    }
       ...
       el resultat és el p.i. */
    {
      ...
      if (isEntagled and itEn!=nullptr) {
        itEn->isEntagled = false;
        if (itEn->pitem != itEn->plist->iteminf.next) (*itEn)--;
        itEn->isEntagled = true;
      }
      return *this;
    }
